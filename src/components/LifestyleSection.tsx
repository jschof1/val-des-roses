  ...
  return (
    <section ref={ref} className="bg-cream overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen overflow-hidden">
        ...
        >
          <div className="max-w-md">
            <h3 className="text-4xl lg:text-5xl font-light tracking-wide text-dark mb-8 leading-tight">
              Wabi Sabi
              <br />
              Philosophy
            </h3>
            <div className="h-px bg-burgundy w-16 mb-8" />
      ...
      <motion.div
        ...
        className="min-h-screen flex items-center justify-center p-8 bg-white/30"
      >
        <div className="text-center max-w-4xl">
          <h3 className="text-5xl lg:text-7xl font-light tracking-wide text-dark mb-12 leading-tight">
            Confident Elegance
          </h3>
          <div className="h-px bg-burgundy w-32 mx-auto mb-12" />
          <p className="text-xl lg:text-2xl text-dark/70 leading-relaxed mb-16 max-w-3xl mx-auto">
          ...
          <button className="bg-burgundy text-cream px-16 py-5 text-sm font-medium tracking-[0.15em] hover:bg-dark transition-all duration-500">
